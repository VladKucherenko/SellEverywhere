...
(
    ...
    price  INTEGER DEFAULT 0 CHECK(price>=0) NOT NULL,
...
(
    ...
    delivery_price INTEGER DEFAULT 0 CHECK(delivery_price>=0) NOT NULL,
...
(
    ...
    providers_price INTEGER DEFAULT 0 CHECK(providers_price>=0) NOT NULL,
